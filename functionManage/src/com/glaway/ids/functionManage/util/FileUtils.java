...
public class FileUtils {
			...
			if (!file.exists()) {
				...
				if (fileModify.ifExitsUser(fileName, userId)) {
					fileModify.write(fileName,
							fileModify.readLevel(fileName, userId, userLevel));
				} else {
					// 如果不存在就写
					fw = new FileWriter(file, true);
					fw.write("\n");
	...
	public static void main(String[] args) throws Exception{
		String logFileHistory = CommonProperties
		.getStringProperty("logFileHistoryPath");
		String logFile = CommonProperties
